...
var file_hello_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x76,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x53,
	0x74, 0x72, 0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x68, 0x65, 0x6c,
	0x6c, 0x6f, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x32, 0x43, 0x0a, 0x11, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x2e, 0x0a,
	0x05, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x10, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x65, 0x6c, 0x6c,
...
var file_hello_proto_depIdxs = []int32{
	0, // 0: v1.HelloWorldService.hello:input_type -> v1.HelloRequest
	1, // 1: v1.HelloWorldService.hello:output_type -> v1.HelloResponse
...
func (c *helloWorldServiceClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1.HelloWorldService/hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorldService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.HelloWorldService/Hello",
	}
...
var _HelloWorldService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "v1.HelloWorldService",
